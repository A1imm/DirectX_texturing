...
namespace Geometry
{
	...
	inline std::pair<VertexBuffer, IndexBuffer> CreateBoxGeometry()
	{
		std::vector<Vertex> vertices =
		{
			...
			// Right face
			Vertex({ DirectX::XMFLOAT3(1.0f, -1.0f, -1.0f), DirectX::XMFLOAT2(0.0f, 2.0f) }), //4
			Vertex({ DirectX::XMFLOAT3(1.0f,  1.0f, -1.0f), DirectX::XMFLOAT2(0.0f, 0.0f) }), //5
			Vertex({ DirectX::XMFLOAT3(1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 0.0f) }), //6
			Vertex({ DirectX::XMFLOAT3(1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 2.0f) }), //7

			// Left face
			Vertex({ DirectX::XMFLOAT3(-1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 2.0f) }), //8
			Vertex({ DirectX::XMFLOAT3(-1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 0.0f) }), //9
			Vertex({ DirectX::XMFLOAT3(-1.0f,  1.0f, -1.0f), DirectX::XMFLOAT2(2.0f, 0.0f) }), //10
			Vertex({ DirectX::XMFLOAT3(-1.0f, -1.0f, -1.0f), DirectX::XMFLOAT2(2.0f, 2.0f) }), //11

			// Bottom face
			Vertex({ DirectX::XMFLOAT3(-1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 2.0f) }), //12
			Vertex({ DirectX::XMFLOAT3(-1.0f, -1.0f, -1.0f), DirectX::XMFLOAT2(0.0f, 0.0f) }), //13
			Vertex({ DirectX::XMFLOAT3(1.0f, -1.0f, -1.0f), DirectX::XMFLOAT2(2.0f, 0.0f) }), //14
			Vertex({ DirectX::XMFLOAT3(1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 2.0f) }), //15

			// Top face
			Vertex({ DirectX::XMFLOAT3(-1.0f,  1.0f, -1.0f), DirectX::XMFLOAT2(0.0f, 2.0f) }), //16
			Vertex({ DirectX::XMFLOAT3(-1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 0.0f) }), //17
			Vertex({ DirectX::XMFLOAT3(1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 0.0f) }), //18
			Vertex({ DirectX::XMFLOAT3(1.0f,  1.0f, -1.0f), DirectX::XMFLOAT2(2.0f, 2.0f) }), //19

			// Back face
			Vertex({ DirectX::XMFLOAT3(1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 2.0f) }), //20
			Vertex({ DirectX::XMFLOAT3(1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(0.0f, 0.0f) }), //21
			Vertex({ DirectX::XMFLOAT3(-1.0f,  1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 0.0f) }), //22
			Vertex({ DirectX::XMFLOAT3(-1.0f, -1.0f,  1.0f), DirectX::XMFLOAT2(2.0f, 2.0f) })  //23
		};
